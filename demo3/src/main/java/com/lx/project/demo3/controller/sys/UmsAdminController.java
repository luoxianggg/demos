...
import com.lx.project.demo3.dto.UmsAdminLoginParam;
import com.lx.project.demo3.dto.UmsAdminParam;
import com.lx.project.demo3.model.Response;
import com.lx.project.demo3.model.sys.UmsAdmin;
...
public class UmsAdminController {
    ...
    @ResponseBody
    public Object register(@RequestBody UmsAdminParam umsAdminParam) {
        UmsAdmin umsAdmin = adminService.register(umsAdminParam);
        if (umsAdmin == null) {
            new Response().failure();
        }
        return new Response().success(umsAdmin);
    }
    ...
    public Object login(@RequestBody UmsAdminLoginParam umsAdminLoginParam, BindingResult result) {
        ...
        if (token == null) {
            return new Response().validateFailed("用户名或密码错误");
        }
        Map<String, String> tokenMap = new HashMap<>();
        tokenMap.put("token", token);
        tokenMap.put("tokenHead", tokenHead);
        return new Response().success(tokenMap);
    }
    ...
    public Object list(@RequestParam(value = "name",required = false) String name,
        ...
        return new Response().success(adminList);
    }
